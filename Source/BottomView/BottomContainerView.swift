...
open class BottomContainerView: UIView {
    ...
    lazy var pickerVideoButton: ButtonVideoPicker = { [unowned self] in
        ...
        pickerVideoButton.isHidden = true
    ...
    lazy var swipeMenuView: SwipeMenuView = { [unowned self] in
        let swipeMenuView = SwipeMenuView()
    ...
    func configure() {
        [borderPickerButton, pickerButton, pickerVideoButton,/* switchCameraModeButton,*/ swipeMenuView, doneButton, topSeparator].forEach {
            addSubview($0)
